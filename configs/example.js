...
ports1.tls = false;
ports1.difficulty = {};
ports1.difficulty.initial = 0.000007;
ports1.difficulty.minimum = 0.000001;
ports1.difficulty.maximum = 1;
...
// Coin Configuration
config.primary.coin = {};
config.primary.coin.name = 'Kylacoin';
config.primary.coin.symbol = 'KCN';
config.primary.coin.algorithm = 'flex';
