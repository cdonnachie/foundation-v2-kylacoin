...
const Loader = function(logger, configMain) {
  ...
  this.handleConfigs = function() {
    ...
    if (fs.existsSync(normalizedPath + 'kylacoin.js')) {
      config = require(normalizedPath + 'kylacoin.js');
      ...
      throw new Error('Unable to find kylacoin.js file. Read the installation/setup instructions');
    }
    return config;
  };
};
